    ...
    _createClass(ScrollArea, [{
        ...
        value: function getOuterWidth() {
            ...
            if (isPercentage) {
                ...
                return _DOMHelper2.default.getWidth(this.refs['outer']) * percentage;
            }

            return parseInt(this.props.width || _DOMHelper2.default.getWidth(this.refs['outer']) || 0, 10);
        }
    }, {
        key: 'getOuterHeight',
        value: function getOuterHeight() {
            ...
            if (isPercentage) {
                ...
                return _DOMHelper2.default.getHeight(this.refs['outer']) * percentage;
            }

            return parseInt(this.props.height || _DOMHelper2.default.getHeight(this.refs['outer']) || 0, 10);
        }
    }, {
        key: 'getInnerHeight',
